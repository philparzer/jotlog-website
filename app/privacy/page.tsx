    ...
    <main className="mt-[80px] overflow-hidden min-h-[100vh]">
      <div className="flex w-full justify-between px-[5vw] lg:px-[25vw] flex-col">
        ...
        <div>
          ...
          (hereinafter referred to as the &ldquo;Service&ldquo;) is operated by Philipp Parzer and adlerlagune [hereinafter referred to as &ldquo;us&ldquo;, "our", "we"]. This page informs you of

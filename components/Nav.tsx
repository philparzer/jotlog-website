...
export default function Nav() {
  return (
    <nav className="top-0 lg:top-[20px] rounded-none lg:rounded-full z-10 bg-[#F9FCF7] sticky w-[100vw] nav lg:w-auto lg:border lg:border-[#f8e4ff40] px-[5vw] lg:mx-[25vw] lg:bg-white py-[16px] flex justify-between lg:justify-normal items-center lg:px-[40px] text-sm">
